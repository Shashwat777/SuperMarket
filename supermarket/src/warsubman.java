...
public class warsubman {
	...
	public void update(ActionEvent event) throws IOException {
		if ((whadminlogin.currentwha.mywh.inventory.containsKey(cat.getText()))
				&& ( whadminlogin.currentwha.mywh.inventory.get(cat.getText()).subcats.containsKey(subcat.getText()))) {
			Subcategory subcats = whadminlogin.currentwha.mywh.inventory.get(cat.getText()).subcats
					.get(subcat.getText());
			whadminlogin.currentwha.mywh.inventory.get(cat.getText()).subcats.remove(subcat.getText());
			whadminlogin.currentwha.mywh.inventory.get(cat.getText()).subcats.put(nname.getText(), subcats);
			subcat.setText("");
			nname.setText("");
	...
	public void add(ActionEvent event) throws IOException {
		...
		if (whadminlogin.currentwha.mywh.inventory.containsKey(cat.getText())) {
			...
			Category ct=whadminlogin.currentwha.mywh.inventory.get(cat.getText());
